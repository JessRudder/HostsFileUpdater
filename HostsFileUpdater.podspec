#
# Be sure to run `pod lib lint HostsFileUpdater.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/HostsFileUpdater.git", :tag => s.version.to_s }
